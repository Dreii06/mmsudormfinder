        ...
        <div class="registercontainer">
            ...
            @csrf
                <legend>Register</legend>
                    <hr style="width:90%;">
                        <input type="email" id="email" name="email" required placeholder="Email" class="loginform" style="margin-top:10px;width:30%;"> 
                        <input type="text" id="dormname" name="dorm_name" required placeholder="Dorm Name" class="loginform" style="margin-top:10px;width:30%;">
                        <input type="text" id="mnumber" name="mobile_number" required placeholder="Mobile Number" class="loginform" style="margin-top:10px;width:30%;"> <br>

                        <input type="text" id="fullname" name="first_name" required placeholder="First Name" class="loginform" style="margin-top:10px;width:30%;"> 
                        <input type="text" id="fullname" name="middle_name"  placeholder="Middle Name" class="loginform" style="margin-top:10px;width:30%;"> 
                        <input type="text" id="fullname" name="last_name" required placeholder="Last Name" class="loginform" style="margin-top:10px;width:30%;"><br>

                        <input type="password" id="password" name="password" required placeholder="Password" class="loginform" style="margin-top:10px;width:30%;"> 
                        <input type="password" id="cpassword" name="password_confirmation" required placeholder="Confirm Password" class="loginform" style="margin-top:10px;width:30%;"> <br>
